...
EMP_BUILD_CONFIG(
  ...
  VALUE(N_NODES_PER_CPU, size_t, 1, "How many nodes should we simulate per CPU?"),
  VALUE(RUN_SECONDS, double, 30,
  ...
  VALUE(N_CHANNELS, size_t, 2, "Number of node colors available"),
