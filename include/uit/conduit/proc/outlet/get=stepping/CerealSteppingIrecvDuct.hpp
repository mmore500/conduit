...
public:
  ...
  [[noreturn]] void Put(const T&) const {
    throw "Put called on CerealSteppingIrecvDuct";
  }

  [[noreturn]] bool IsReadyForPut() const {
    throw "IsReadyForPut called on CerealSteppingIrecvDuct";
  }
  ...
  static std::string GetName() { return "CerealSteppingIrecvDuct"; }
