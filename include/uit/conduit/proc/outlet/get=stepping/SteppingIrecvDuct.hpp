...
public:
  ...
  [[noreturn]] void Put(const T&) const {
    throw "Put called on SteppingIrecvDuct";
  }

  [[noreturn]] bool IsReadyForPut() const {
    throw "IsReadyForPut called on SteppingIrecvDuct";
  }
  ...
  static std::string GetName() { return "SteppingIrecvDuct"; }
